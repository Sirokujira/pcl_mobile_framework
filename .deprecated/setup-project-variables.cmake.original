...
option(BUILD_IOS_DEVICE_ARM64E "Build for iOS device(arm64e)" OFF)
...
set(toolchain_ios_device_arm64e ${toolchain_dir}/iOS_Device_ARM64e.cmake)
...
set(try_run_results_pcl_ios_device_arm64e ${toolchain_dir}/pcl-try-run-results.cmake)
